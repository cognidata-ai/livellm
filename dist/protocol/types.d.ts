 ...
 */
export declare function isStreamEvent(value: unknown): value is StreamEvent;
export declare function isTokenEvent(event: StreamEvent): event is TokenEvent;
export declare function isErrorEvent(event: StreamEvent): event is ErrorEvent;
export declare function isMetadataEvent(event: StreamEvent): event is MetadataEvent;
export declare function isDoneEvent(event: StreamEvent): event is DoneEvent;
